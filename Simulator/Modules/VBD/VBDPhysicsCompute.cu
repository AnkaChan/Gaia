...
void GAIA::VBDSolveParallelGroup_vertexSweep_2hierarchiesGPU(VBDPhysicsDataGPU* pPhysicsData, int32_t* vertexParallelGroupsHead,
...
void GAIA::VBDSolveParallelGroup_updateVertexPositionGPU(VBDPhysicsDataGPU* pPhysicsData, int32_t* vertexParallelGroupsHead, 
...
//}
//
void GAIA::GDSolveParallelGroup_allInOneSweepGPU(VBDPhysicsDataGPU* pPhysicsData, int32_t* vertexParallelGroupsHead, int32_t veretxParallelGroupSize, 
	int32_t numThreads, cudaStream_t cudaStream)
{
...
void GAIA::GDSolveParallelGroup_BlockJacobi_allInOneSweepGPU(VBDPhysicsDataGPU* pPhysicsData, int32_t* vertexParallelGroupsHead, int32_t veretxParallelGroupSize, int32_t numThreads, cudaStream_t cudaStream)
{
...
void GAIA::GDSolveParallelGroup_updatePositionSweepGPU(VBDPhysicsDataGPU* pPhysicsData, CFloatingTypeGPU stepSize, CFloatingTypeGPU acceleratorOmega, int32_t* vertexParallelGroupsHead, int32_t veretxParallelGroupSize, int32_t numThreads, cudaStream_t cudaStream)
{
...
void GAIA::VBDUpdateVelocityGPU(VBDPhysicsDataGPU* pPhysicsData, const int32_t* vertexAllParallelGroups, const int32_t numVertices,
	int32_t numThreads, cudaStream_t cudaStream)
{
